...
class EncoderFXCompTest {
    ...
    void constructorDoesNotThrow() {
        CANDeviceID canId = new CANDeviceID(80);
        ControllerTalonFX fx =
                new ControllerTalonFX(parent, "TestFX", canId, new MotorBase(MotorType.KRAKENX60));

        EncoderFXComp encoder = new EncoderFXComp(parent, "TestEncoder", fx, 250.0);

        assertNotNull(encoder);
    }

    /* --- Position and velocity default to 0 before robotInit --- */
