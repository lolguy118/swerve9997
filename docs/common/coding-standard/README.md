...
| File | Scope |
| ---- | ----- |
| [`Team271-Software-Coding-Standard.md`](Team271-Software-Coding-Standard.md) | Core: §1 Introduction, §2 Language and Build, §3 Source-code presentation, §4 Coding Guidelines (router to companions) |
