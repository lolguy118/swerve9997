...
| NullAway (Error Prone plugin) | Planned | Annotation set + layered rollout defined by [ADR-018](adr/ADR-018-null-safety-annotation-policy.md); enable per its rollout |
