...
| 2 | [development-setup.md](development-setup.md) | Get Java 17, WPILib, and Gradle working; run tests locally |
...
| [development-setup.md](development-setup.md) | All contributors | `build.gradle`, continuous-integration (CI) workflow |
