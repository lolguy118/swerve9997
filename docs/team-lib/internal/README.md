...
| File | What it shows |
| ---- | ------------- |
| [`team271-lib-dependency-diagram.mmd`](team271-lib-dependency-diagram.mmd) | The six-layer architecture in diagram form — cited by [ADR-003 Layered Architecture](../planning/adr/ADR-003-layered-architecture.md). Includes the vision vendors ([ADR-007](../planning/adr/ADR-007-vendor-neutral-vision-abstraction.md)) and the CAN-bus abstraction ([ADR-006](../planning/adr/ADR-006-can-bus-abstraction.md)). |
...
| [`team271-lib-periodic-flow-diagram.mmd`](team271-lib-periodic-flow-diagram.mmd) | Sequence of one robot cycle: bulk CAN refresh ([ADR-009](../planning/adr/ADR-009-centralized-can-refresh.md)), desired-to-actual reconciliation ([ADR-010](../planning/adr/ADR-010-desired-to-actual-state-pattern.md)), and per-subsystem exception isolation ([ADR-011](../planning/adr/ADR-011-subsystem-exception-isolation.md)). |
| [`team271-lib-automove-composition-diagram.mmd`](team271-lib-automove-composition-diagram.mmd) | Class hierarchy of the autonomous-move type system and the `CommandBridge` adapter — cited by [ADR-013](../planning/adr/ADR-013-composition-over-commands.md) and [ADR-014](../planning/adr/ADR-014-trajectory-following-vendors.md). |
| [`team271-lib-api-vendor-map-diagram.mmd`](team271-lib-api-vendor-map-diagram.mmd) | Which vendor class implements which `api/` interface — visualises [ADR-008](../planning/adr/ADR-008-ctre-phoenix6-primary-vendor.md), [ADR-007](../planning/adr/ADR-007-vendor-neutral-vision-abstraction.md), and [ADR-006](../planning/adr/ADR-006-can-bus-abstraction.md). |
