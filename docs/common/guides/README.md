...
project** — the library, a season robot, or any standalone tool.
...
> because the setup docs apply to anyone who clones a repository
> for the first time. This folder is the generic half.
