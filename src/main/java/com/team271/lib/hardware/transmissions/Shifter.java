 ...
 *
 * <p>Separates the physical actuation mechanism (pneumatics, servo, motor, etc.) from the
 * transmission's gear state and ratio bookkeeping. Implementations handle the hardware-specific
 * details of engaging a gear.
 */
